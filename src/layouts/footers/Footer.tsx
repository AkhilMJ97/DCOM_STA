...
import footer_logo from "@/assets/img/logo.svg";
...
const footer_data: DataType = {
  ...
  footer_info: `Welcome to our e-commerce platform, where we specialize in transforming the online shopping experience. Discover personalized solutions tailored to your needs, from dynamic product recommendations to seamless transactions. Let us help your business thrive in the digital marketplace.`,
  links: [
    { title: `HOME`, link: "/" },
